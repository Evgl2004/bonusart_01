...
class BotsDashboardServiceTests(TestCase):
    def test_builds_daily_rows_and_kpis(self):
        ...
        self.assertEqual(payload["delta_baseline"]["channels_total_telegram"], 0)
        self.assertEqual(payload["delta_baseline"]["channels_registered_optin_telegram"], 0)
        self.assertEqual(payload["delta_baseline"]["channels_total_vk"], 0)
        self.assertEqual(payload["delta_baseline"]["channels_registered_optin_vk"], 0)
        self.assertEqual(payload["delta_baseline"]["channels_total_max"], 0)
        self.assertEqual(payload["delta_baseline"]["channels_registered_optin_max"], 0)
        self.assertEqual(payload["delta_baseline"]["unique_persons_total"], 0)
        self.assertEqual(payload["delta_baseline"]["unique_persons_registered_optin"], 0)
